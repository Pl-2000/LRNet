...
class LRNet(nn.Module):
    def __init__(self, lrnet_cos_sim_threshold=0.4, lrnet_label_threshold=0.5):
        ...
        self.RCA1 = RCA(64, cos_sim_threshold=lrnet_cos_sim_threshold, label_threshold=lrnet_label_threshold)
        self.RCA2 = RCA(128, cos_sim_threshold=lrnet_cos_sim_threshold, label_threshold=lrnet_label_threshold)
        self.RCA3 = RCA(256, cos_sim_threshold=lrnet_cos_sim_threshold, label_threshold=lrnet_label_threshold)
        self.RCA4 = RCA(512, cos_sim_threshold=lrnet_cos_sim_threshold, label_threshold=lrnet_label_threshold)
        self.RCA5 = RCA(512, cos_sim_threshold=lrnet_cos_sim_threshold, label_threshold=lrnet_label_threshold)
    ...
    def forward(self, x_t1, x_t2):
        ...
        main_stream_layer1, sa_weights1 = self.RCA1(main_stream_layer1, t1_stream_layer1, t2_stream_layer1)
        ...
        main_stream_layer2, sa_weights2 = self.RCA2(main_stream_layer2, t1_stream_layer2, t2_stream_layer2, pre_sa_weights2)
        ...
        main_stream_layer3, sa_weights3 = self.RCA3(main_stream_layer3, t1_stream_layer3, t2_stream_layer3, pre_sa_weights3)
        ...
        main_stream_layer4, sa_weights4 = self.RCA4(main_stream_layer4, t1_stream_layer4, t2_stream_layer4, pre_sa_weights4)
        ...
        main_stream_layer5, sa_weights5 = self.RCA5(main_stream_layer5, t1_stream_layer5, t2_stream_layer5, pre_sa_weights5)
